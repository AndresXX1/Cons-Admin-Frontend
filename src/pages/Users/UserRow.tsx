  ...
  return (
    <>
      ...
      <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr] gap-6 relative items-center justify-start">
        ...
        <p className="text-[1rem] text-argenpesos-textos font-book text-center">{calculateAge(user.birthday) || "-"}</p>
        <p className="text-[1rem] text-argenpesos-textos font-book text-center">{user.points || "-"}</p>
        <p className="text-[0.9rem] text-argenpesos-textos font-book text-center">{formatDateString(user.create).slice(0, 13) || "-"}</p>
        <p className="text-[1rem] text-argenpesos-textos font-book text-center translate-x-5">
        ...
        <div className="w-[114%] h-[1px] bg-argenpesos-gray mt-5 col-span-6 mb-10 -ml-[5%]"></div>
      </div>
