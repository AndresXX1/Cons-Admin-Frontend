  ...
  const AllAddress: React.FC<UserAddressesProps> = ({ userId, user, onClose }) => {
    ...
    const validateAddressFields = (addressToValidate: AddressType) => {
      ...
      if (!addressToValidate.number) {
        ...
        newErrors.number = 'El número debe ser un valor numérico de hasta 4 dígitos.';
      }
          ...
          element={
            <div className="space-y-4 max-w-4xl mx-auto p-6">
              ...
              <h2 className="text-2xl font-semibold text-center text-gray-700 mb-10">
                {addressToEdit ? `Editar Domicilio ${addressToEditIndex! + 1} de ${user.firstName}` : "Agregar Domicilio"}
              </h2>
              ...
              <div className="grid grid-cols-2 gap-x-4 ml-10">
                ...
                <input
                  ...
                  onInput={(e: React.FormEvent<HTMLInputElement>) => {
                    ...
                    const inputValue = e.currentTarget.value.replace(/[^a-zA-Z\s]/g, ''); // Elimina números y caracteres especiales
        ...
        <div className="grid grid-cols-3 gap-x-4 ml-10">
          <div className="col-span-3">
            ...
            <select
              ...
              className={`w-[617px] h-[54px] rounded-[5px] border-[1px] border-solid ${errors.province ? 'border-red-500' : 'border-argenpesos-gray'}`}
              autoComplete="off" 
            >
            ...
            {errors.province && <p className="text-red-500 text-xs">{errors.province}</p>} {/* Validación provincia */}
          </div>
        </div>
