...
const ModalAction = ({
  ...
  return (
    <div className="bg-white w-[calc(100%-20px)] sm:w-[464px] px-[28px] py-[36px] rounded-[20px] relative">
      ...
      />
      <p className="text-argenpesos-black font-poppinsMedium text-[20px]">
        {title}
      </p>
      <div className="flex flex-col pt-[24px] mt-[24px] border-t-[1px] border-t-argenpesos-black">
        ...
        <div className="flex gap-4 mt-[32px]">
          <button
            type="button"
            onClick={() => close()}
            className="w-[150px] h-[45px] rounded-full border-[1px] border-argenpesos-skyBlue text-argenpesos-skyBlue"
          >
          ...
          <button
            ...
            className="w-[150px] bg-argenpesos-skyBlue h-[45px] rounded-full border-[1px]"
          >
